...
public class ListBasic extends AppCompatActivity {
    ...
    private TextView createNewPost, myPosts, messages;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createNewPost = findViewById(R.id.newPost);
        myPosts = findViewById(R.id.myPosts);
        messages = findViewById(R.id.messages);

        createNewPost.setOnClickListener((view) -> {
            view.setBackground(getDrawable(R.color.grey_100));
            Intent intent = new Intent(ListBasic.this, FormTextArea.class);
            startActivity(intent);
        });

        myPosts.setOnClickListener((view) -> {
            view.setBackground(getDrawable(R.color.grey_100));
            Intent intent = new Intent(ListBasic.this, MyPosts.class);
            startActivity(intent);
        });
...
//        items.addAll(DataGenerator.getPeopleData(this));
        ...
        mAdapter.setOnItemClickListener(new AdapterListBasic.OnItemClickListener() {
            ...
            public void onItemClick(View view, Job obj, int position) {
                //TODO
                Intent intent = new Intent(ListBasic.this, DetailView.class);
